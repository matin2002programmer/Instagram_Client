...
A powerful and flexible **Instagram Media Downloader & Uploader** built
in Python.\
This client allows you to programmatically download, upload, interact
with posts, and manage sessions using Instagram's private web APIs.
...
-   Instagram private API can change at any time --- updates may be
    required
-   Automating likes/comments too fast may trigger rate limits\
-   For private profiles, you **must** be logged in and have access\
-   Large downloads (full profiles) may take time depending on network
    speed
